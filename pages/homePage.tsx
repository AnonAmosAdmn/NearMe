  ...
  return (
    <Box bg="linear-gradient(to bottom, #2979FF, #000000)" minHeight="100vh" py={8}>
      <Box textAlign="center" maxW="md" mx="auto">
        ...
        {locationData && (
          <Center mt={4}>
            <Box width="md" mb={4} bg="white" p={4} borderRadius="md" boxShadow="md">
              ...
              {userLocation && (
                <Center mb={2}>
                  <iframe
                    title="Google Map"
                    src={`https://www.google.com/maps/embed/v1/place?key=${GOOGLE_MAPS_API_KEY}&q=${userLocation}&zoom=13`}
                    width="400"
                    height="400"
                  />
                </Center>
